...
void GLBlendFuncSeparate(struct GLVampContext* vampContext, int i, int j, int k, int l);
void GLAlphaFunc(struct GLVampContext *vampContext, int i, float j);
void GLBlendColor(struct GLVampContext* vampContext, float r, float g, float b, float a);
void GLBlendEquation(struct GLVampContext* vampContext, int mode);
